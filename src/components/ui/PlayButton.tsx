...
const PlayButton = ({ onClick, ...props }: PlayButtonProps) => {
    return (
        <button
            onClick={onClick}
            className="group relative flex items-center justify-center gap-2.5 px-3 h-12 text-white uppercase tracking-widest font-semibold text-[17px] cursor-pointer border-2 border-black bg-[#fdd835] rounded-full overflow-hidden transition-all duration-500 active:scale-90 hover:shadow-xl"
            style={{ textShadow: '2px 2px rgb(116, 116, 116)' }}
            {...props}
        >
            <div className="relative z-10 transition-all duration-500 group-hover:scale-[3] group-hover:translate-x-1/2">
            ...
            <span className="absolute left-0 -translate-x-full transition-all duration-500 delay-300 z-20 group-hover:translate-x-2.5">now!</span>
            <span className="transition-all duration-500 delay-300 group-hover:translate-x-[200%]">play</span>
        </button>
    );
};
