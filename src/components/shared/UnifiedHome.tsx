...
const AutoSizer = (ReactAutoSizer as any).default || ReactAutoSizer;
...
export default function UnifiedHome() {
            ...
            <div style={{ ...style, paddingLeft: 20, paddingRight: 20, paddingBottom: 20 }}>
                ...
                >
                    ...
                    <div className="flex items-center justify-between mb-6 relative z-10">
                        ...
                        <button className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-white/20 hover:text-white transition-all">
                    ...
                    <div className="flex gap-3 relative z-10">
                        <button className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 text-[10px] font-bold text-white/40 hover:bg-rose-500/10 hover:text-rose-500 transition-all border border-white/5 uppercase tracking-widest group/btn">
                            <Heart size={14} className="group-hover/btn:scale-110 transition-transform" /> {post.likes}
                        </button>
                        <button className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 text-[10px] font-bold text-white/40 hover:bg-blue-500/10 hover:text-blue-500 transition-all border border-white/5 uppercase tracking-widest">
    ...
    return (
        <div className="flex-1 flex flex-col h-full bg-[#050505] relative selection:bg-rose-500/30 font-sans">
            {/* Background Atmosphere */}
            <div className="absolute inset-0 z-0 opacity-30 pointer-events-none">
                <LiquidImage strength={0.01} speed={0.1} />
            </div>
            ...
            <header className="px-6 py-6 flex items-center justify-between relative z-10">
                ...
                <button className="w-10 h-10 rounded-full bg-white/5 border border-white/5 flex items-center justify-center text-white/40 hover:text-white hover:bg-white/10 transition-all">
                    <Settings size={18} />
                </button>
            </header>
